...
Due to a bug in the Google crawler that occurs when a repo is switched from private to public, you can't find the real Screen Operator via Google search, but via Bing and Yahoo. The real repo with code is [here](https://github.com/Android-PowerUser/ScreenOperator).
